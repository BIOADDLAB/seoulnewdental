        ...
        <main className="w-full">
            ...
            >
                <div className="mx-auto max-w-[900px] flex flex-col items-center">
                    ...
                    <VerticalDivider length="h-[43px] lg:h-[60px]" color="bg-primary-dark/50" spacing="top" />

                    <Reveal
                        variant="fade-up"
                        className="w-full max-w-[820px] bg-white rounded-[5px] px-[17px] py-[20px] lg:px-[36px] lg:py-[26px] mt-[30px] lg:mt-[50px]"
                    >
            ...
            <section className="w-full bg-primary py-[70px] px-[24px] lg:py-[100px]">
                <Reveal
                    variant="fade-up"
                    className="mx-auto max-w-[900px] flex flex-col items-center text-center text-white"
                >
            ...
            >
                <div className="mx-auto max-w-[848px] flex flex-col items-center">
                    <Reveal
                        variant="fade-up"
                        className="w-[274px] h-[34px] lg:w-[500px] lg:h-[47px] flex items-center justify-center text-white bg-[linear-gradient(90deg,rgba(255,255,255,0)_0%,#769283_20%,#769283_80%,rgba(255,255,255,0)_100%)]"
                    >
                    ...
                    <ul className="grid grid-cols-2 gap-y-[18px] lg:gap-y-[27px] mt-[36px] lg:mt-[56px] w-full ">
                        {EXTRACTION_CASES.map((item, idx) => (
                            <Reveal
                                key={item}
                                as="li"
                                variant="fade-up"
                                delay={idx * 70}
                                className="flex items-start gap-[5px] lg:gap-[10px]"
                            >
                                <img
                    ...
                    <div className="w-full flex lg:px-0 flex-col-reverse lg:flex-row items-end justify-between gap-[28px] lg:gap-[30px] mt-[60px] lg:mt-[110px]">
                        <Reveal variant="slide-right" className="w-full lg:max-w-[480px]">
                        ...
                        <Reveal
                            variant="slide-left"
                            className="relative w-full h-[133px] lg:w-[428px] lg:h-[264px] shrink-0 overflow-hidden rounded-[6px]"
                        >
                            <Image
