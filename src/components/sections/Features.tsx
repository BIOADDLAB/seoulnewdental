        ...
        >
            <div className="mx-auto max-w-[1200px] flex flex-col items-center">
                ...
                <div className="relative w-full max-w-[1000px] flex flex-col mt-[35px] md:mt-[50px] lg:mt-[72px] lg:flex-row lg:justify-between items-center lg:items-stretch z-10">
                    <Reveal
                        variant="scale-in"
                        className="relative mb-[37px] lg:mb-0 lg:absolute lg:top-1/2 lg:left-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 z-20 w-[234px] h-[234px] lg:w-[404px] lg:h-[404px]"
                    >
                        <div className="relative bg-primary/40 w-full h-full rounded-full">
                            <div className="absolute bg-primary/70 w-[192px] h-[192px] lg:w-[309px] lg:h-[309px] lg:bottom-[17px] rounded-full bottom-[12px] left-1/2 -translate-x-1/2">
                                <div className="absolute bg-primary w-[144px] h-[144px] lg:w-[233px] lg:h-[233px] lg:bottom-[17px] rounded-full bottom-[10px] left-1/2 -translate-x-1/2 flex justify-center items-center text-center text-white text-[18px]/[25px] lg:text-[25px]/[43px] font-semibold">
                                    <span className={`whitespace-pre-line ${centerBoxClassName}`}>{centerText}</span>
                                </div>
                            </div>
                        </div>
                    </Reveal>
                    ...
                    <div className="flex lg:hidden w-full flex-col gap-[30px] mb-[30px]">
                        {items.map((item, idx) => (
                            <Reveal
                                ...
                                variant="fade-up"
                                delay={idx * 90}
                                className="relative w-full flex flex-col items-center bg-transparent"
                            >
                ...
                {bottomBox && (
                    <Reveal
                        variant="fade-up"
                        className="relative mt-[50px] lg:mt-[80px] w-full max-w-[800px] bg-white border border-gray-300 rounded-[12px] px-[24px] pt-[45px] pb-[24px] lg:px-[32px] lg:py-[32px] flex flex-col lg:flex-row justify-center items-center gap-[16px] lg:gap-[40px] shadow-sm"
                    >
